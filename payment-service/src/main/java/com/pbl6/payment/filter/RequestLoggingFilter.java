package com.pbl6.payment.filter;
...
public class RequestLoggingFilter implements Filter {
    ...
    private void logIncomingRequest(HttpServletRequest request, String requestId) {
        ...
        log.info("┌─────────────────────────────────────────────────────────────");
        log.info("│ [PAYMENT-SERVICE] REQUEST RECEIVED");
        log.info("├─────────────────────────────────────────────────────────────");
    ...
    private void logOutgoingResponse(HttpServletRequest request, HttpServletResponse response, 
        ...
        if (status < 400) {
            log.info("┌─────────────────────────────────────────────────────────────");
            log.info("│ [PAYMENT-SERVICE] RESPONSE SENT - {}", logLevel);
            log.info("├─────────────────────────────────────────────────────────────");
            log.info("│ Request ID     : {}", requestId);
            log.info("│ Method         : {}", method);
            log.info("│ Path           : {}", uri);
            ...
            log.warn("┌─────────────────────────────────────────────────────────────");
            log.warn("│ [PAYMENT-SERVICE] RESPONSE SENT - {}", logLevel);
            log.warn("├─────────────────────────────────────────────────────────────");
