...
public record CreateOrderRequest(
        @Schema(description = "Pickup address for the order", required = true)
        ...
        @Schema(description = "Voucher code applied to the order")
        String voucherCode,

        @Schema(description = "Whether the package is fragile")
        Boolean fragile,

        @Schema(description = "Whether a thermal bag is requested")
        Boolean thermalBag,

        @Schema(description = "Return to pickup location when COD fails")
