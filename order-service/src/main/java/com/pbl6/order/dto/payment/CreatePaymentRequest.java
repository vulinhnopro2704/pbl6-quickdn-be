...
/**
 * Request DTO for our backend API: POST /api/payment This is what clients send to our service (not
 * directly to payOS)
 */
@Data
@Builder
...
public class CreatePaymentRequest {
  ...
  @Schema(
      description =
          "Payment link expiration time as Unix timestamp (seconds). If not provided, uses default from config.",
      example = "1731024000",
      required = false)
