...
public record PackageDto(
    @Schema(description = "Unique identifier of the package") UUID id,
    ...
    @Schema(description = "Package status") PackageStatus packageStatus,
    @Schema(description = "Status note") String statusNote,
    @Schema(description = "Status updated at") LocalDateTime statusUpdatedAt,
